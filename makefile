...
main: $(BIN)/rutas_aereas
	./$(BIN)/rutas_aereas ./$(DATOS)/paises.txt ./$(DATOS)/imagenes/mapas/mapa1.ppm  ./$(DATOS)/imagenes/banderas/ ./$(DATOS)/almacen_rutas.txt ./$(DATOS)/imagenes/aviones/avion2.ppm ./$(DATOS)/imagenes/aviones/mascara_avion2.pgm
